...
public class StartWith implements Task {
    ...
    public static Performable creditCalculatorPage() {
        return Instrumented.instanceOf(StartWith.class).withProperties("/loans/cash-loan");
    }
    public static Performable cardOrderPage() {
        return Instrumented.instanceOf(StartWith.class).withProperties("/cards/debit-cards/tinkoff-black/#form");
    }
}
