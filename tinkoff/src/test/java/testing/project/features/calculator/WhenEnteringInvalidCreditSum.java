...
public class WhenEnteringInvalidCreditSum {
    ...
    @Test
    public void shouldBeAbleToSeeHelpMessage() {
        ...
        then(borat).should(seeThat(CreditCalculatorPrice.is(), containsString("Укажите сумму кредита"))); // credit cost has not changed
    }
}
