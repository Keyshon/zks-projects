...
public class WhenChangingSiteCategory {
    ...
    public static Collection<Object[]> testData(){
        return Arrays.asList(new Object[][]{
                ...
                {SiteCategory.Business,  SiteCategory.Business.getPageTitle()},
                {SiteCategory.Invest, SiteCategory.Invest.getPageTitle()},
                {SiteCategory.Insurance, SiteCategory.Insurance.getPageTitle()},
                {SiteCategory.Mobile, SiteCategory.Mobile.getPageTitle()},
                {SiteCategory.Flights, SiteCategory.Flights.getPageTitle()},
                {SiteCategory.Entertainment, SiteCategory.Entertainment.getPageTitle()}
        });
    }
