...
import testing.project.pageobjects.AlfaBankTopNavigationMenu;
...
public class NavigateTo implements Task {
    ...
    private AlfaBankTopNavigationMenu alfaBankTopNavigationMenu;
        ...
        switch (taskName) {
            case INDEX:
                actor.attemptsTo(
                        ...
                        Click.on(AlfaBankTopNavigationMenu.siteLogo()));
                break;
            case CATEGORY:
                actor.attemptsTo(
                        Open.browserOn(alfaBankTopNavigationMenu),
                        Click.on(AlfaBankTopNavigationMenu.siteCategoryMenuSection(category)));
                break;
            case ONLINE_BANKING:
                actor.attemptsTo(
                        Open.browserOn(alfaBankTopNavigationMenu),
                        Click.on(AlfaBankTopNavigationMenu.onlineBankingButton()));
                break;
            default:
                break;
        }
