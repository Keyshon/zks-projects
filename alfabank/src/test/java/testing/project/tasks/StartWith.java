...
public class StartWith implements Task {
    ...
    public static Performable creditCalculatorPage() {
        return Instrumented.instanceOf(StartWith.class).withProperties("/get-money/credit/credit-cash");
    }
    public static Performable cardOrderPage() {
        return Instrumented.instanceOf(StartWith.class).withProperties("/everyday/debit-cards/alfacard-beta-2/");
    }
}
