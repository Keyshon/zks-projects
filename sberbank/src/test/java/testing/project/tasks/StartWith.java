...
public class StartWith implements Task {
    ...
    public static Performable creditCalculatorPage() {
        return Instrumented.instanceOf(StartWith.class).withProperties("/person/credits/money/consumer_unsecured");
    }
    public static Performable cardOrderPage() {
        return Instrumented.instanceOf(StartWith.class).withProperties("/person/bank_cards/debit/karta-s-bolshimi-bonusami/orderpremiumcard");
    }
}
