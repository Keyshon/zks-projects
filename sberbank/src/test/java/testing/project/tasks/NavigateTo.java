...
import testing.project.pageobjects.SberbankTopNavigationMenu;
...
public class NavigateTo implements Task {
    ...
    private SberbankTopNavigationMenu sberbankTopNavigationMenu;
        ...
        switch (taskName) {
            case INDEX:
                actor.attemptsTo(
                        ...
                        Click.on(SberbankTopNavigationMenu.siteLogo()));
                break;
            case CATEGORY:
                actor.attemptsTo(
                        Open.browserOn(sberbankTopNavigationMenu),
                        Click.on(SberbankTopNavigationMenu.siteCategoryMenuSection(category)));
                break;
            case ONLINE_BANKING:
                actor.attemptsTo(
                        Open.browserOn(sberbankTopNavigationMenu),
                        Click.on(SberbankTopNavigationMenu.onlineBankingButton()));
                break;
            default:
                break;
        }
